...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "p0lcmBesGllx2xG8dpv32f5j";
    public static String secretKey = "paHZgsWmGkgvQsbfiwWeG9FcCr28YwgL";
    public static String licenseID = "clfxiaoweib-face-android";
     ...
     */
    public static String groupID = "chuanglefu01";
