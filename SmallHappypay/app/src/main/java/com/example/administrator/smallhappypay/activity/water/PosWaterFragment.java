...
public class PosWaterFragment extends Fragment {

    @BindView(R.id.poswater_lv)
    ListView poswaterLv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_pos_water_fragment, container, false);
        unbinder = ButterKnife.bind(this, view);
        amNumber = SPUtils.getString(getActivity(), "amNumber");

        getposwater(0, amNumber, "pos", count);
        initRefresh();
        ...
        unionView.setXRefreshViewListener(new XRefreshView.SimpleXRefreshListener() {
            ...
            public void onLoadMore(boolean isSilence) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        getposwater(1, amNumber, "pos", count);
                    }
                }, 2000);
            }
        });
    ...
    private void initView() {
        ...
        poswaterLv.setAdapter(waterAdapter);
        waterAdapter.notifyDataSetChanged();
    }
