...
public class FileUtil
{
	...
	public static final String IMESSAGE_VOICE = getExternalStorePath() + "/file/voice";
	public static final String IMESSAGE_IMAGE = getExternalStorePath() + "/file/image";
	public static final String IMESSAGE_FILE = getExternalStorePath() + "/file/file";
	public static final String IMESSAGE_MOVES = getExternalStorePath() + "/file/moves";
