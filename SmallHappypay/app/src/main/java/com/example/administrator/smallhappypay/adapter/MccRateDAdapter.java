...
public class MccRateDAdapter extends BaseAdapter {

    private LayoutInflater mInflater;
    private List<MccRateBean.MapBean.DBean> mList;
    private Context mContext;

    public MccRateDAdapter(Context context, List<MccRateBean.MapBean.DBean>list){
        mContext=context;
        mList=list;
