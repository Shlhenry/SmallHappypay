...
/**
 * 状态栏工具类
 * Created by macaruina on 2017/9/1.
 */
...
public class StatusUtils {
     ...
     */
    public static void setStatusBar(Activity activity, boolean permeate, boolean withoutUseStatusBarColor) {
     ...
     * @param permeate               是否沉浸
     * @param useThemestatusBarColor 是否不需要使用状态栏为暗色调
     * @param activity
     */
    public static void setStatusTextColor(boolean useDart, boolean permeate, boolean useThemestatusBarColor, Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {//5.0及以上
