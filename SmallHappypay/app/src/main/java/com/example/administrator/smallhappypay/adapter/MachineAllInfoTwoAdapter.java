...
public class MachineAllInfoTwoAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<MachineInfoBean.MapBean.TwoBean> mList;
    private Context mContext;

    public MachineAllInfoTwoAdapter(Context context, List<MachineInfoBean.MapBean.TwoBean> list){
        mContext = context;
        mList = list;
