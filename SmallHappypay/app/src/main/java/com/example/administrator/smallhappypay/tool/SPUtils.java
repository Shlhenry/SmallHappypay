...
public class SPUtils {
    ...
    public static void saveList(Context context, String key, List<String> datas) {
        JSONArray mJsonArray = new JSONArray();
        for (int i = 0; i < datas.size(); i++) {
            mJsonArray.put(datas.get(i));
        }
    ...
    public static List<String> getLists(Context context, String key) {
    ...
    public static <T> boolean saveObject(Context context, String name, String key, T t) {
        try {
            ...
            oos.writeObject(t);
            String payCityMapBase64 = new String(android.util.Base64.encode(toByte.toByteArray(), android.util.Base64.DEFAULT));
    ...
    public static <T> T getObject(Context context, String name, String key) {
        try {
            ...
            byte[] base64Bytes = android.util.Base64.decode(payCityMapBase64, android.util.Base64.DEFAULT);
