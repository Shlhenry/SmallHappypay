...
public class AlipayWaterFragment extends Fragment {

    @BindView(R.id.alipaywater_lv)
    ListView alipaywaterLv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_alipay_water_fragment, container, false);
        unbinder = ButterKnife.bind(this, view);
        amNumber = SPUtils.getString(getActivity(), "amNumber");

        getposwater(0, amNumber, "zfb", count);
        initRefresh();
        return view;
    }
        ...
        unionView.setXRefreshViewListener(new XRefreshView.SimpleXRefreshListener() {
            ...
            public void onLoadMore(boolean isSilence) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        getposwater(1, amNumber, "zfb", count);
                    }
                }, 2000);
            }
        });
    ...
    private void initView() {
        ...
        alipaywaterLv.setAdapter(waterAdapter);
        waterAdapter.notifyDataSetChanged();
    }
