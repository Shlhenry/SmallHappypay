...
public class MachineBindingThreeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine_binding_three);
        ButterKnife.bind(this);

        toolbarTitleTv.setText("云POS终端绑定");
        ...
        switch (view.getId()) {
            ...
            case R.id.machine_okbinding_imgbtn:
                if (machineSnEt.length()<=0||"请选择型号".equals(machineSelectTv.getText().toString())){
                    mdialog(MachineBindingThreeActivity.this,"请先完善信息");
                }else {
                    LoadingDialog(MachineBindingThreeActivity.this,"请稍等");
    ...
    private void initListPopupIfNeed() {
        if (mListPopup == null) {
            ...
            mListPopup = new QMUIListPopup(MachineBindingThreeActivity.this, QMUIPopup.DIRECTION_NONE, queryModleAdapter);
            mListPopup.create(QMUIDisplayHelper.dp2px(MachineBindingThreeActivity.this, 150), QMUIDisplayHelper.dp2px(MachineBindingThreeActivity.this, 200), new AdapterView.OnItemClickListener() {
                @Override
    ...
    private void QueryModel(String type) {
        Api.gethttpService().getqueryModelData(type).enqueue(new Callback<QueryModelBean>() {
            ...
            public void onResponse(Call<QueryModelBean> call, Response<QueryModelBean> response) {
                ...
                if ("00".equals(queryModelBean.getCode())){
                    if (queryModelBean.getList()!=null){
                        ...
                        mdialog(MachineBindingThreeActivity.this,"暂无机器");
                    }
                }else {
                    mdialog(MachineBindingThreeActivity.this,response.body().getMessage());
                }
            }
            ...
            public void onFailure(Call<QueryModelBean> call, Throwable t) {
                dismiss();
                mdialog(MachineBindingThreeActivity.this,"服务器维护中");
            }
        });
    }
        ...
        Api.gethttpService().getMachineData(amNumber, sn, mmName).enqueue(new Callback<NoBackBean>() {
            ...
            public void onResponse(Call<NoBackBean> call, Response<NoBackBean> response) {
                ...
                if ("00".equals(response.body().getCode())){
                    ...
                    mdialog(MachineBindingThreeActivity.this,response.body().getFailMessage());
                }
            }
            @Override
